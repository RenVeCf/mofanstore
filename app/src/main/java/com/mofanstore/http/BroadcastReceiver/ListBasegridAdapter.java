...
public abstract class ListBasegridAdapter<T> extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    protected Context mContext;
    private LayoutInflater mInflater;
    public static final int TYPE_TOP_IMAGE = 0;
    public static final int TYPE_BOTTON_IMAGE = 1;
    public static final int TYPE_BOTTON_IMAG2E = 2;
    protected List<T> mDataList = new ArrayList<>();

    public ListBasegridAdapter(Context context) {
        mContext = context;
