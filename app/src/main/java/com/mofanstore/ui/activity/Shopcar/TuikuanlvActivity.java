...
public class TuikuanlvActivity extends BaseActivity implements SwipeRefreshLayout.OnRefreshListener {
    ...
    public void initView() {
        ...
        if (swipeRefreshLayout != null) {
            swipeRefreshLayout.setProgressViewOffset(false, 0, AppUtil.dip2px(TuikuanlvActivity.this, 48));
            swipeRefreshLayout.setColorSchemeResources(android.R.color.holo_blue_light, android.R.color.holo_red_light, android.R.color.holo_orange_light, android.R.color.holo_green_light);
            swipeRefreshLayout.setOnRefreshListener(this);
        }
        recyclerview.setLayoutManager(new LinearLayoutManager(TuikuanlvActivity.this));
        recycleAdapter = new RecycleAdapter(TuikuanlvActivity.this);
...
//    }
    ...
    public class RecycleAdapter extends ListBaseAdapter<String> {
        ...
        public int getLayoutId() {
            return R.layout.activity_tuikuanitem;
        }
        ...
        public void onBindItemHolder(SuperViewHolder holder, final int position) {
            ...
            red_tv.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    Intent intent=new Intent(context, TuikuandetailActivity.class);
