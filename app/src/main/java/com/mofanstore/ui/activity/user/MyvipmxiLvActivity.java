...
public class MyvipmxiLvActivity extends BaseActivity implements SwipeRefreshLayout.OnRefreshListener {
    ...
    public int intiLayout() {
        return R.layout.activit_myjifen;
    }

    @Override
    public void initView() {
        tvName.setText("成长值明细");
        commit.setVisibility(View.GONE);
        //设置刷新时动画的颜色，可以设置4个
        if (swipeRefreshLayout != null) {
            swipeRefreshLayout.setProgressViewOffset(false, 0, AppUtil.dip2px(MyvipmxiLvActivity.this, 48));
            swipeRefreshLayout.setColorSchemeResources(android.R.color.holo_blue_light, android.R.color.holo_red_light, android.R.color.holo_orange_light, android.R.color.holo_green_light);
            swipeRefreshLayout.setOnRefreshListener(this);
        }
        recyclerview.setLayoutManager(new LinearLayoutManager(MyvipmxiLvActivity.this));
        recycleAdapter = new RecycleAdapter(MyvipmxiLvActivity.this);
...
//    }
    ...
    public class RecycleAdapter extends ListBaseAdapter<String> {
        ...
        public int getLayoutId() {
            return R.layout.activity_mxitem;
        }
