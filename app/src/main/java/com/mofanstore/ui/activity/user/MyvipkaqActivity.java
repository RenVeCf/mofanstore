...
public class MyvipkaqActivity extends BaseActivity implements SwipeRefreshLayout.OnRefreshListener{
    ...
    public void initView() {
        tvName.setText("VIP卡券");

        //设置刷新时动画的颜色，可以设置4个
        if (swipeRefreshLayout != null) {
            swipeRefreshLayout.setProgressViewOffset(false, 0, AppUtil.dip2px(MyvipkaqActivity.this, 48));
            swipeRefreshLayout.setColorSchemeResources(android.R.color.holo_blue_light, android.R.color.holo_red_light, android.R.color.holo_orange_light, android.R.color.holo_green_light);
            swipeRefreshLayout.setOnRefreshListener(this);
        }
        recyclerview.setLayoutManager(new LinearLayoutManager(MyvipkaqActivity.this));
        recycleAdapter = new RecycleAdapter(MyvipkaqActivity.this);
...
//    }
    ...
    public class RecycleAdapter extends ListBaseAdapter<String> {
        ...
        public int getLayoutId() {
            return R.layout.activity_vipitem;
        }
