...
public class MyjifenActivity extends BaseActivity implements SwipeRefreshLayout.OnRefreshListener {
    ...
    public void initView() {
        ...
        if (swipeRefreshLayout != null) {
            swipeRefreshLayout.setProgressViewOffset(false, 0, AppUtil.dip2px(MyjifenActivity.this, 48));
            swipeRefreshLayout.setColorSchemeResources(android.R.color.holo_blue_light, android.R.color.holo_red_light, android.R.color.holo_orange_light, android.R.color.holo_green_light);
            swipeRefreshLayout.setOnRefreshListener(this);
        }
        recyclerview.setLayoutManager(new LinearLayoutManager(MyjifenActivity.this));
        recycleAdapter = new RecycleAdapter(MyjifenActivity.this);
...
//    }
    ...
    public class RecycleAdapter extends ListBase2Adapter<String> {
        ...
        public int getLayoutId() {
            return R.layout.activity_jifenitem;
        }

        @Override
        public int getLayouttopId() {
            return R.layout.activity_jifentop;
        }
