...
public class HulanissueLvActivity extends BaseActivity implements SwipeRefreshLayout.OnRefreshListener{
    ...
    public int intiLayout() {
        return R.layout.activit_hulanissuelv;
    }
    ...
    public void initView() {
        ...
        if (swipeRefreshLayout != null) {
            swipeRefreshLayout.setProgressViewOffset(false, 0, AppUtil.dip2px(HulanissueLvActivity.this, 48));
            swipeRefreshLayout.setColorSchemeResources(android.R.color.holo_blue_light, android.R.color.holo_red_light, android.R.color.holo_orange_light, android.R.color.holo_green_light);
            swipeRefreshLayout.setOnRefreshListener(this);
        }
        recyclerview.setLayoutManager(new LinearLayoutManager(HulanissueLvActivity.this));
        recycleAdapter = new RecycleAdapter(HulanissueLvActivity.this);
...
//    }
    ...
    public class RecycleAdapter extends ListBaseAdapter<String> {
        ...
        public int getLayoutId() {
            return R.layout.activity_issueitem;
        }
