...
public class MydingzhilvActivity extends BaseActivity implements SwipeRefreshLayout.OnRefreshListener{
    ...
    public void initView() {
        ...
        if (swipeRefreshLayout != null) {
            swipeRefreshLayout.setProgressViewOffset(false, 0, AppUtil.dip2px(MydingzhilvActivity.this, 48));
            swipeRefreshLayout.setColorSchemeResources(android.R.color.holo_blue_light, android.R.color.holo_red_light, android.R.color.holo_orange_light, android.R.color.holo_green_light);
            swipeRefreshLayout.setOnRefreshListener(this);
        }
        recyclerview.setLayoutManager(new LinearLayoutManager(MydingzhilvActivity.this));
        recycleAdapter = new RecycleAdapter(MydingzhilvActivity.this);
...
//                }
        ...
        mLuRecyclerViewAdapter.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                Intent intent=new Intent(MydingzhilvActivity.this,DingzhidetailActivity.class);
...
//    }
        ...
        public void onBindItemHolder(SuperViewHolder holder, final int position) {
            ...
            cart_list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                    Intent intent=new Intent(context, DingzhidetailActivity.class);
                    startActivity(intent);
                }
            });
    ...
    public void Deleorder(final String id, final int type,final int postion) {
        final Dialog dl = new Dialog(MydingzhilvActivity.this, R.style.dialog);
        View view = LayoutInflater.from(MydingzhilvActivity.this).inflate(
