...
public class MyadderlvActivity extends BaseActivity implements SwipeRefreshLayout.OnRefreshListener {
    ...
    public void initView() {
        ...
        if (swipeRefreshLayout != null) {
            swipeRefreshLayout.setProgressViewOffset(false, 0, AppUtil.dip2px(MyadderlvActivity.this, 48));
            swipeRefreshLayout.setColorSchemeResources(android.R.color.holo_blue_light, android.R.color.holo_red_light, android.R.color.holo_orange_light, android.R.color.holo_green_light);
            swipeRefreshLayout.setOnRefreshListener(this);
        }
        recyclerview.setLayoutManager(new LinearLayoutManager(MyadderlvActivity.this));
...
//                }
    ...
    public void onRefresh() {
        recycleAdapter = new RecycleAdapter(MyadderlvActivity.this);
        mLuRecyclerViewAdapter = new LuRecyclerViewAdapter(recycleAdapter);
        recyclerview.setAdapter(mLuRecyclerViewAdapter);
...
//    }
    ...
    public class RecycleAdapter extends ListBaseAdapter<String> {
        ...
        public void onBindItemHolder(SuperViewHolder holder, final int position) {
            TextView nameadd = holder.getView(R.id.nameadd);
            if (flag == 0) {
                nameadd.setText("邮编：887654");
            } else {
                nameadd.setText("");
            }
        }
    ...
    public void onViewClicked(View view) {
        ...
        switch (view.getId()) {
            ...
            case R.id.comnit:
                if (flag == 0) {
                    Intent intent=new Intent(MyadderlvActivity.this,AdderActivty.class);
