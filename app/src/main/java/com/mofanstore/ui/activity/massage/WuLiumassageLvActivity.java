...
public class WuLiumassageLvActivity extends BaseActivity implements SwipeRefreshLayout.OnRefreshListener{
    ...
    public void initView() {
        ...
        if (swipeRefreshLayout != null) {
            swipeRefreshLayout.setProgressViewOffset(false, 0, AppUtil.dip2px(WuLiumassageLvActivity.this, 48));
            swipeRefreshLayout.setColorSchemeResources(android.R.color.holo_blue_light, android.R.color.holo_red_light, android.R.color.holo_orange_light, android.R.color.holo_green_light);
            swipeRefreshLayout.setOnRefreshListener(this);
        }
        recyclerview.setLayoutManager(new LinearLayoutManager(WuLiumassageLvActivity.this));
        recycleAdapter = new RecycleAdapter(WuLiumassageLvActivity.this);
