...
public class Huabo2frarment extends BaseFragment {
    ...
    private Huboitem2Fragment huboitem2Fragment;
    TextView tab_text;
    ...
    protected void initData() {
        ...
        for (int i = 0; i < str.length; i++) {
            fragments.add(huboitem2Fragment.newInstance(""));
        }
    ...
    public static Huabo2frarment newInstance(String cats_id) {
        Huabo2frarment fragment = new Huabo2frarment();
