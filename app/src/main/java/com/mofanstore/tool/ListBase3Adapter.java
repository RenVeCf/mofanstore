...
public abstract class ListBase3Adapter<T> extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    protected Context mContext;
    private LayoutInflater mInflater;
    public static final int TYPE_TOP_IMAGE = 0;
    public static final int TYPE_CERTER_IMAGE = 1;
    public static final int TYPE_BOTTON_IMAGE = 2;
    protected List<T> mDataList = new ArrayList<>();

    public ListBase3Adapter(Context context) {
        mContext = context;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        }else if (viewType == TYPE_CERTER_IMAGE){
            itemView = mInflater.inflate(getLayoutcenterId(), parent, false);
            return new SuperViewfourHolder(itemView);
        }else{
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        }else if (holder instanceof SuperViewfourHolder){
            onBindItem3Holder((SuperViewfourHolder)holder, position);
        }else {
    ...
    public abstract int getLayoutcenterId();
    ...
    public abstract void onBindItem3Holder(SuperViewfourHolder holder, int position);
