...
public class RoundImagecfView extends ImageView {
    ...
    public RoundImagecfView(Context context) {
        this(context, null);
    }

    public RoundImagecfView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public RoundImagecfView(Context context, AttributeSet attrs, int defStyleAttr) {
